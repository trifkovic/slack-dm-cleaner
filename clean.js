...
const token = '*'; // Replace * with your user OAuth token (USER! not bot!)
const channelId = '*'; // Replace * with the actual DM Channel ID (Slack browser, open a DM with somebody, last part of the URL https://app.slack.com/client/WORKSPACE_ID/YOUR_DM_ID)
const userId = '*'; // Replace * with your user ID (Slack browser, click on yourself, last part of the URL https://app.slack.com/client/WORKSPACE_ID/YOUR_USER_ID)
